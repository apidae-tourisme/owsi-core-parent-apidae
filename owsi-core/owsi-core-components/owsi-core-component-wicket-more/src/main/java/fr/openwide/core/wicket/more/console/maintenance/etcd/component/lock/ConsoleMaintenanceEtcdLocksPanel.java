	...
	public ConsoleMaintenanceEtcdLocksPanel(String id) {
		...
		add(
				DataTableBuilder.start(
						...
						.addColumn(
								new AbstractCoreColumn<ILock, ISort<?>>(new ResourceModel("business.etcd.lock.key")) {
									private static final long serialVersionUID = 1L;
									@Override
...
//			super(id, "lockAttribution", ConsoleMaintenanceEtcdLocksPanel.this, lockModel);
//			
//			lockAttributionModel = new LoadableDetachableModel<ILockAttribution>() {
//				private static final long serialVersionUID = 1L;
//				@Override
//				protected ILockAttribution load() {
//					return etcdClusterService.getLockAttribution(lockModel.getObject());
//				}
//			};
//			
//			add(
...
//	}
	...
	private class LockKeyFragment extends Fragment {
		...
		public LockKeyFragment(String id, IModel<ILock> lockModel) {
			super(id, "lockKey", ConsoleMaintenanceEtcdLocksPanel.this, lockModel);
